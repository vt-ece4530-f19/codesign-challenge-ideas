...
(
    ...
    localparam PAD5 = log2ceil(64'h4021060 - 64'h4021040); 
    localparam PAD6 = log2ceil(64'h4021070 - 64'h4021060); 
    localparam PAD7 = log2ceil(64'h4021080 - 64'h4021070); 
    localparam PAD8 = log2ceil(64'h4021090 - 64'h4021080); 
    localparam PAD9 = log2ceil(64'h40210a0 - 64'h4021090); 
    localparam PAD10 = log2ceil(64'h40210a8 - 64'h40210a0); 
    // -------------------------------------------------------
    ...
    // ( 0x4021060 .. 0x4021070 )
    if ( {address[RG:PAD6],{PAD6{1'b0}}} == 27'h4021060   ) begin
            src_channel = 11'b00000000010;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 1;
    end

    // ( 0x4021070 .. 0x4021080 )
    if ( {address[RG:PAD7],{PAD7{1'b0}}} == 27'h4021070  && read_transaction  ) begin
            src_channel = 11'b01000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 7;
    end

    // ( 0x4021080 .. 0x4021090 )
    if ( {address[RG:PAD8],{PAD8{1'b0}}} == 27'h4021080   ) begin
            src_channel = 11'b00100000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 6;
    end

    // ( 0x4021090 .. 0x40210a0 )
    if ( {address[RG:PAD9],{PAD9{1'b0}}} == 27'h4021090   ) begin
            src_channel = 11'b00010000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 5;
    end

    // ( 0x40210a0 .. 0x40210a8 )
    if ( {address[RG:PAD10],{PAD10{1'b0}}} == 27'h40210a0   ) begin
